...
const ChangePassword = () => {
  ...
  const handleSubmitClick = () => {
    if (email && newpassword && newconfirm && code !== "") {
      setErrMsg("");
  ...
  return (
    redirect ?? (
      ...
      >
        <div className="  p-4  bg-[#1F2122] rounded-md shadow-md  ">
          ...
          <p className="my-2 text-yellow-400 ">Email Verification</p>
          <input
            type="code"
            className=" focus:ring-2 w-40 p-2 rounded-md"
